...
import '../../Features/code/domain/use_cases/generate_codes_uc.dart';
import '../../Features/code/domain/use_cases/get_codes_centers_uc.dart';
...
void injectUC() {
  ...
  locator.registerFactory<GenerateCodesUC>(
    () => GenerateCodesUC(
      repository: locator(),
    ),
  );
