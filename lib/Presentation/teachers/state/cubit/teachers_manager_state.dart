...
final class TeachersManagerTeacherPurchases extends TeachersManagerState {
  final List<PurchaseItem> teacherPurchases;

  const TeachersManagerTeacherPurchases({required this.teacherPurchases});

  @override
  List<Object> get props => [teacherPurchases];
}
